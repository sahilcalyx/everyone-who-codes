...
const fluidShader = `
  ...
  void main() {
      ...
      if (iFrame < 1) {
          ...
          // Add automatic continuous flow
          float noise = sin(0.01 * U.x + iTime * 0.5) * cos(0.01 * U.y + iTime * 0.3);
          me.xy += vec2(cos(iTime * 0.2 + U.y * 0.01), sin(iTime * 0.15 + U.x * 0.01)) * 0.002;
          me.xy += vec2(noise, -noise) * 0.001;
